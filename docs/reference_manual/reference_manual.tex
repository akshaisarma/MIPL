...
or_terms
	...
	;
\end{lstlisting}
$;$ expression is an expression which concatenates terms, and those terms
 will be true in Boolean statement if one of terms is ture.
...
\end{lstlisting}
$,$ expression is an expression which concatenates terms, and those terms
 will be true in Boolean statement if all terms are ture.
...
term
	...
	;
\end{lstlisting}
$Term$ is a basic block in MIPL. $Term$ can be 
