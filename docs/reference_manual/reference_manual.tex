...
A STRING\_LITERAL is any sequence of characters, enclosed within a " and a " 
or within a ' and a '. These sequence of characters cannot include the 
enclosing characters unless they are properly escaped with the escape key
\\.
...
be accessed. For instance, given a 5 x 7 matrix A, A[2~4,6~][1] produces the
...
the character '~' representing all valid indices or any combination of placing
...
the left or the right of the '~' character, it defaults to the extreme 
